...
@interface BrowserViewController : UIViewController <UIActionSheetDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate, UITextFieldDelegate,UIWebViewDelegate,UIDocumentInteractionControllerDelegate> {
    ...
    NSString *userAgent,*iBooksPDFPath,*oldPDF;
    ...
    int i;
    IBOutlet UIButton *btnIBooks;
    BOOL value;
    IBOutlet UILabel *lblOpenin;
    NSTimer *timer;
    int j;
}
...
@property(nonatomic,strong) NSString *enteredurl;
